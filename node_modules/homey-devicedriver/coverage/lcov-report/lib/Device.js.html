...
<html lang="en">
<head>
    <title>Code coverage report for lib/Device.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> Device.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >			this.settings[setting.id] = {</span>
				get: () =&gt; {
<span class="cstat-no" title="statement not covered" >					return this.settings[setting.id].value;</span>
				},
				set: value =&gt; {
<span class="cstat-no" title="statement not covered" >					if (typeof this.settings[setting.id].value !== 'undefined' &amp;&amp; this.settings[setting.id].value !== value) {</span>
<span class="cstat-no" title="statement not covered" >						this.emit(`setting_${setting.id}_changed`, value);</span>
					}
<span class="cstat-no" title="statement not covered" >					this.settings[setting.id].value = value;</span>
				},
				value: setting.value
			}
		});
...
&nbsp;
	...
	getInitializationRetryInterval() {
		...
		else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.initializationRetryCount &gt;= 8) return 15 * 60000; // 15 minutes
	}
&nbsp;
	markAsUnavailable<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >		this.emit('unavailable');</span>
	}
&nbsp;
	/**
...
<span class="cstat-no" title="statement not covered" >			if (this.pollingIntervals.hasOwnProperty(i)) {</span>
<span class="cstat-no" title="statement not covered" >				clearInterval(this.pollingIntervals[i]);</span>
<span class="cstat-no" title="statement not covered" >				delete this.pollingIntervals[i];</span>
			}
		}
...
&nbsp;
module.exports = Device;</pre></td></tr>
</table></pre>
